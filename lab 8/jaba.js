...
Department.prototype.giveSalary = function() {
 ...
 function main() {
	const dev = new Developer("Andrii", "Petrenko", 1000, 5);
  	const dev2 = new Developer("Vitalii", "Papenko", 1000, 1);
 	 const dev3 = new Developer("Grigoriy", "Vivchar", 1200, 9);
 	 const dev4 = new Developer("Ivan", "Kotlyar", 1100, 9);
  const des = new Designer("Alex", "Hart", 1200, 6, 0.5);
  const des1 = new Designer("Ervin", "Romelko", 1000, 6, 0.7);
  const manager = new Manager("Bill", "Darkholm", 1400, 5, [dev, dev2, dev3, dev4,des,des1]);
